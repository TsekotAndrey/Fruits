...
public class Hockey {
    void StartGame() {
        ...
        System.out.println("Слово которое следует отгадать состоит из 6 букв. Представляет собой вид спортивного состязания.");
    }
    ...
    void Scanner(){
        ...
        if(Q.equals(phrase4)){
            ...
            System.out.println(new Phrases().getFinalPhraseNeg());
        }
